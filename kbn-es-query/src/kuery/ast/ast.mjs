...
import { peg$parse as parseKuery} from '@cybernetex/kbn-es-query/src/kuery/ast/kuery.mjs';
import { KQLSyntaxError } from '@cybernetex/kbn-es-query/src/kuery/errors/index.mjs';
